...
<div class="container" style="margin-top: 150px;">
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            ?>
                <a class="dropdown-item" href="<?= base_url('track/set_active_order/' . $item['id']) ?>">
                    <p>Order <?= $item['id'] ?></p>
                </a>
            <?php
            }
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td class="pt-0"><?= $item['order_id'] ?></td>
                            <td class="pt-0"><?= $item['nama'] . ' : ' . $item['model_produk'] ?></td>
                            <td class="pt-0"><?= $item['pcs'] ?></td>
                            <td class="pt-0"><?= $item['subtotal'] ?></td>
                        </tr>
                <?php
                    }
                }
