      ...
      <?php foreach ($query as $p) : ?>
        <tr>
          ...
          <td>
            ...
            <!-- <a href="#" class="delete" data-toggle="modal" data-target="#deleteModal"><i class="material-icons"
              data-toggle="tooltip" title="Delete">&#xE872;</i></a> -->
            <a class="btn btn-primary mb-2" href="<?= base_url('admin/pembayaran/' . $p->id) ?>">Lihat pembayaran</a>
            <a class="btn btn-primary mb-2" href="<?= base_url('admin/detailorder/' . $p->id) ?>">Detail</a>
          </td>
        </tr>
        <?php $i++; ?>
      <?php endforeach; ?>
